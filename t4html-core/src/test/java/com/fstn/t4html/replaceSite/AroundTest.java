...
public class AroundTest {
    String fromFolder = "src"+File.separator+"test"+File.separator+"resources"+File.separator+ "aroundSite";
    String toFolder = "src"+File.separator+"test-result"+File.separator+"resources"+File.separator+ "aroundSite";
    @Test
    public void simpleModuleCase() {

        String expectedBlocksResult = "<!--start-block:describe:footerline-total-net-amount--><!--start-block:describe:footerline-total-net-amount-->\n" +
