...
public class BeforeTest {
    String fromFolder = "src"+File.separator+"test"+File.separator+"resources"+File.separator+ "beforeSite";
    String toFolder = "src"+File.separator+"test-result"+File.separator+"resources"+File.separator+ "beforeSite";
    @Test
